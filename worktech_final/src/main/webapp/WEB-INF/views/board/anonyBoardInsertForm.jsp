        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="anonyList.bo">익명 게시판</a></div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">익명 게시판 등록</h2>
                <form action="ainsert.bo" method="post" enctype="Multipart/form-data">
	                <div class="row">
